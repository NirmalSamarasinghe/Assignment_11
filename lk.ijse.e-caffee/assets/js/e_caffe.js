...
const loadingScreen1 = document.querySelector('#CustomerPage');
const loadingScreen2 = document.querySelector('#ItemPage');
const loadingScreen3 = document.querySelector('#OrderPage');
const loadingScreen4 = document.querySelector('#orderDetailsPage');
